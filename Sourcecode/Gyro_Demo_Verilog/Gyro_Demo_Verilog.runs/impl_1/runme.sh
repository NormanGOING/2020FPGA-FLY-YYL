...
HD_PWD='C:/Users/17319/Desktop/YYL/Gyro_Demo_Verilog/Gyro_Demo_Verilog.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Gyro_Demo_Verilog.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Gyro_Demo_Verilog.tcl -notrace
