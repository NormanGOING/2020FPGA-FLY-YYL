...
HD_PWD='C:/Users/17319/Desktop/YYL/Gyro_Demo_Verilog/Gyro_Demo_Verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Gyro_Demo_Verilog.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Gyro_Demo_Verilog.tcl
